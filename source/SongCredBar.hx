...
class SongCredBar extends FlxSpriteGroup
{
    ...
    public function new(_x:Float, _y:Float, _song:String) {
        ...
        text.setFormat(Paths.font("funkin.ttf"), fontSize, FlxColor.WHITE, FlxTextAlign.LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);

        text.text = Assets.getText(Paths.txt(_song.toLowerCase() + "/info"));
